...
_Last updated: 2025-11-18 11:32:54 UTC_
...
|---------|----------------|--------|-------|--------|
| `invenio-files-rest` <br/> [patched](packages/invenio-files-rest/test-output-patched.txt) [xml-patched](packages/invenio-files-rest/test-report-patched.xml) [warnings-patched](packages/invenio-files-rest/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-drafts-resources` <br/> [patched](packages/invenio-drafts-resources/test-output-patched.txt) [xml-patched](packages/invenio-drafts-resources/test-report-patched.xml) [warnings-patched](packages/invenio-drafts-resources/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-access` <br/> [patched](packages/invenio-access/test-output-patched.txt) [xml-patched](packages/invenio-access/test-report-patched.xml) [warnings-patched](packages/invenio-access/warnings-patched.md) | pytest-invenio | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-requests` <br/> [patched](packages/invenio-requests/test-output-patched.txt) [xml-patched](packages/invenio-requests/test-report-patched.xml) [warnings-patched](packages/invenio-requests/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
| `invenio-pages` <br/> [patched](packages/invenio-pages/test-output-patched.txt) [xml-patched](packages/invenio-pages/test-report-patched.xml) [warnings-patched](packages/invenio-pages/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-audit-logs` <br/> [patched](packages/invenio-audit-logs/test-output-patched.txt) [xml-patched](packages/invenio-audit-logs/test-report-patched.xml) [warnings-patched](packages/invenio-audit-logs/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-github` <br/> [patched](packages/invenio-github/test-output-patched.txt) [xml-patched](packages/invenio-github/test-report-patched.xml) [warnings-patched](packages/invenio-github/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
| `invenio-vocabularies` <br/> [patched](packages/invenio-vocabularies/test-output-patched.txt) [xml-patched](packages/invenio-vocabularies/test-report-patched.xml) [warnings-patched](packages/invenio-vocabularies/warnings-patched.md) | pytest-invenio invenio-files-rest | ⏭️  Skip | ✅ Pass | ✅ Patch applied successfully, tests passed |
...
#### Warning 1 - 265 occurrences

DeprecationWarning: datetime.datetime.utcnow() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.now(datetime.UTC).

| Package | Count |
|---------|-------|
| `invenio-rdm-records` | 50 |
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('0e416351-7dbc-43ab-b2d7-4a39db38012d'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('1a0bf7e2-2a3e-4dcd-ad86-a291220b44e4'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('1e2b83e6-51c1-4a28-9b98-55a4f65cfa2f'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('6f26b9e1-2cd6-4783-9e8a-2896f1895cc0'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('bf2bd61c-ca32-4cd2-86dc-6a0943e66b8a'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('e29dc172-aa3e-41ab-9f19-628350a8baba'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
...
SAWarning: Identity map already had an identity for (<class 'invenio_jobs.models.Run'>, (UUID('eba8eb19-d121-4060-87f8-22d11be1ce55'),), None), replacing it with newly flushed object.   Are there load operations occurring inside of an event handler within the flush?
